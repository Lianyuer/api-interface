...
import com.yu.apiinterface.common.BaseResponse;
import com.yu.apiinterface.common.ErrorCode;
import com.yu.apiinterface.common.ResultUtils;
import com.yu.apiinterface.exception.ApiException;
...
public class UserController {
    ...
    public BaseResponse<String> getNameById(Long id) {
        User user = userService.getById(id);
        if (user == null) {
            throw new ApiException(ErrorCode.NOT_FOUND_ERROR, "用户不存在");
        }
        return ResultUtils.success("GET 名字是" + user.getUserName());
    }
    ...
    public BaseResponse<String> getUserNameByPost(@RequestBody User user, HttpServletRequest request) {
        ...
        return ResultUtils.success("Post 用户名字是" + user.getUserName());
    }
}
